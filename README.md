...
4. [Переносим управление контентом в настройки страницы/поста](#Переносим-управление-контентом-в-настройки-страницыпоста)
5. [Кастомные типы страниц/постов](#Кастомные-типы-страницпостов)
