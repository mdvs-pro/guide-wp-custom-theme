...
4. [Инициализация скриптов и стилей](#Инициализация-скриптов-и-стилей)
4.1 [Подробный пример подключения скрипта](#Подробный-пример-подключения-скрипта)
5. [Переносим управление контентом в настройки страницы/поста](#Переносим-управление-контентом-в-настройки-страницыпоста)
6. [Кастомные типы страниц/постов](#Кастомные-типы-страницпостов)
7. [Создание дополнительных шаблонов страниц](Создание-дополнительных-шаблонов-страниц)
8. [Полезные плагины](#Полезные-плагины)
